...
if menu_id == "Overview":
    ...
    theme_damage = {'bgcolor': '#f6f6f6','title_color': '#2A4657','content_color': '#0178e4','progress_color': '#0178e4','icon_color': '#0178e4', 'icon': "<i class="fa-solid fa-house-chimney-crack"></i>"}
