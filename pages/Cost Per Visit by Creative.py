...
def clean_and_merge(spend_df, visits_df):
    ...
    merged_df = pd.merge(spend_df, visits_df, on=["Channel", "Creative"], how="inner")
...
def main():
    ...
    st.write("Upload the Spend and Visits Excel files to merge them based on Channel and Creative, calculate Cost per Visit, and sort by Cost per Visit.")
    ...
    if spend_file and visits_file:
        ...
        st.download_button(
            ...
            data=excel_data,
            file_name="merged_channel_creative_data.xlsx",
